...
const ProLevelInfo: FC = () => {
  return (
    <PaddingWrapper>
      <CourseParagraph>
        Консультация-практикум подходит для уровней В1+. Длительность – 2 часа. Перед ее проведением
        я попрошу вас заполнить анкету, чтобы подобрать для вас максимально релевантные материалы.
      </CourseParagraph>
      <CoursePrice price={70} clarification="за 2 часа индивидуального занятия" />
